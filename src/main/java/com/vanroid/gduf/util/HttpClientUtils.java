...
public class HttpClientUtils {
     ...
     */
    public static HttpResult get(HttpSession session ,String url, Map<String, String> headers, Map<String, String> params) throws ClientProtocolException, IOException {
     ...
     * @throws ClientProtocolException
     */
    public static HttpResult post(HttpSession session,String url, Map<String, String> headers, Map<String, String> params, String encoding) throws ClientProtocolException, IOException {
