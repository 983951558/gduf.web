...
public class JwcAction extends ActionSupport implements ModelDriven<JwcInfo> {
	 ...
	 * 
	 * @param JwcLoginInfo类中的stuid和Jwcpassword，已从session中获取，不需要再从客户端上传
	 *
	 */
	public String login() {
		String xm = loginService.login(info);
	 ...
	 * @param JwcInfo类中的xh
	 *            ,year,xq和登陆成功后返回的xm
	 * @param 从客户端传来的数据只有year和xq，其他都从session中获取
	 */
	public String getCourse() {
		...
		Course validCourse = courseService.getCourseInfo(course, xm);
	...
	public String getGrade() {
		...
		Grade validGrade = gradeService.getGradeInfo(grade, xm);
